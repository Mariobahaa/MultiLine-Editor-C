...
//cursor = x;
//pad is not passed by reference into line editor
...
int** multipleLineEditor(int lines,int*sizes,int*xpos,int*ypos,char*r_start,char*r_end,int*length)
{
    system("cls");
    char**pad;
...
//Mario Bahaa Zarif - SD - Mobile V2
